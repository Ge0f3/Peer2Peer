...
public class peer3 extends Thread{
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        /////////////////////////////////////////////////////////////////////////////
        String peerID = "60004";             // the peer ID used as a port listener as well
        ...
        try
        {
            thread = new Thread (new peer3(Integer.parseInt(peerID))); //initiate listener thread
    ...
    public static void list_my_files()
    {
        try {
            ...
            System.out.printf("Peer 3 Files are in %s \n",(folder));
            File[] listOfFiles = folder.listFiles();                                        //store files into file array
            System.out.printf("No of files in peer 3 %s \n",(listOfFiles.length));
